...
try {
    ...
    $sql = "CREATE TABLE IF NOT EXISTS denuncias (
                ...
                tipo_denuncia ENUM('Corrupção', 'Abuso de poder', 'Assédio', 'Outros') NOT NULL,
                descricao TEXT NOT NULL,
                provincia ENUM('Cidade de Maputo', 'Maputo', 'Gaza', 'Inhambane', 'Sofala', 'Manica', 'Tete', 'Zambézia', 'Nampula', 'Niassa', 'Cabo Delgado') NOT NULL,
